defmodule Migracion_no_docentes do
  ...
  def no_docentes() do
    ...
    id_pagina_no_docentes = crear_pagina(nombre_pagina, texto_pagina, id_menu_lateral)
    ...
    ids_navs = Enum.map(
      no_docentes_opts,
      fn elemento ->
        busqueda_recursiva(elemento, url_no_docentes, nombre_pagina, id_menu_lateral)
      end
    )
