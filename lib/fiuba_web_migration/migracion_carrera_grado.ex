defmodule Migracion_carrera_grado do
  ...
  def carreras_grado() do
    ...
    id_pagina_carreras = crear_pagina(nombre_pagina, texto_pagina, nombre_pagina, id_menu_lateral)
    ...
    ids_navs = Enum.map(
      carreras_info ++ carreras,
      fn elemento ->
        busqueda_recursiva(elemento, url_carreras, nombre_pagina, nombre_pagina, id_menu_lateral)
      end
    )
