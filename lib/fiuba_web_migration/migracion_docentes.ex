defmodule Migracion_docentes do
  ...
  def docentes() do
    ...
    nodo_type = docentes |> Enum.at(3)

    id_menu_lateral = crear_menu_lateral(url_docentes)
    id_pagina_docentes = crear_pagina(nombre_pagina, id_menu_lateral)
    ...
    ids_navs_docentes = if (contains?(nodo_type,"panel")) do
      ids_navs
    else
      []
    end

    actualizar_pagina(id_pagina_docentes, texto_pagina, ids_navs_docentes)
